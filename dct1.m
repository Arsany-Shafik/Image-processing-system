...
figure 
subplot(1,2,1),imshow(Kmedian),title('filter')
subplot(1,2,2),imhist(Kmedian),title('histogram filter');


hq=histeq(Kmedian);
figure
subplot(1,2,1),imshow(hq),title('Image Equalization')
subplot(1,2,2),imhist(hq),title('histogram Equalization');
...
figure
subplot(1,2,1),imshow(I_rec),title('Image Reconstructed');
subplot(1,2,2),imhist(I_rec),title('histogram Reconstructed');
figure
subplot(1,2,1),imshow(diff),title('Difference');
subplot(1,2,2),imhist(diff),title('histogram Difference');